            ...
            if (budy) {
                try {
                    ...
                    let prompt_template =
                        ...
                        BOT_NAME +
                        " developed by a Ngonidzashe A Maphosa.\n\nHuman: Hi. How are you?\n" +
                        BOT_NAME +
                    ...
                    //const sendMsg = await openai.createCompletion(id, buttonMessage)
...
*Att:* _Number of words per response have been reduced from 750 to 300._

                   
*From Admin:* I am available for Freelance work, Website Design, App Dev, Marketing, Bot Dev, SEO and more. PING: pocketlabs.co.zw/ngonie.html |`)
                    ...
                    console.log(err)
                    m.reply('Ops!!! I am getting API Update right now. Please hold on and check back in a while.')
                }
            }
        }
